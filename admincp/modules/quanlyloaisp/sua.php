...
<table width="100%" border="1" cellspacing="0px">
  <tr>
    <td colspan="2"><div align="center">Sữa loại sản phẩm</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2">
    	<div align="center">
        <input type="submit" name="sua"  value="Sữa" class="button"/>
    	</div>
   </td>
  </tr>
</table>
<p>&nbsp;</p>	
    ...
    <p><a href="index.php?quanly=quanlyloaisp&ac=them" class="button_them">Quay về Thêm</a></p>
